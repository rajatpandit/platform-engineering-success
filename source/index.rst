...
However, platform engineering is not without its challenges. When I was heading a platform engineering team at a large retailer, I was often confused about how to get enough adoption of the platform by the product teams. I realized that the requirements of the platform were different in each business unit, and that the regular engineering mindset didn't apply and you had to a product first mindset - where the end customers where the internal users. I had to change my approach of finding sponsors, evangelists, and first-customers for the platform within the organization.
...
- How to structure and organize your platform engineering team?
...
Photo by `Marvin Meyer <https://unsplash.com/de/@marvelous?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText>`_ on `Unsplash <https://unsplash.com/photos/SYTO3xs06fU?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText>`_
